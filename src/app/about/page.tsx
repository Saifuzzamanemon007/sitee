      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            Hey there! I'm Saifuzzaman Emon, a passionate Video Editor and Motion
            Graphics Designer at channel i with a deep love for storytelling through visuals.
          </p>
        </motion.div>
          ...
          >
            <GlassmorphismCard className="p-8">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  I specialize in, Premiere Pro, and After Effects —
                   delivering cinematic edits, clean motion graphics,
